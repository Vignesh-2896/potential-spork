        ...
        <div>
            <div className = "SideMenu">
                <ul>
                    ...
                    <li><img src = {OrderIcon} alt = "Order Icon" style = {{marginRight:"15px"}} />Orders</li>
                    <li><img src = {NotificationIcon} alt = "Notification Icon" style = {{marginRight:"15px"}} />Notification</li>
                    <li><img src = {HelpIcon} alt = "Help Icon" style = {{marginRight:"15px"}} />Help & Support</li>
                    <li><img src = {SettingsIcon} alt = "Settings Icon" style = {{marginRight:"15px"}} />Settings</li>
                </ul>
            </div>
        </div>
    )
