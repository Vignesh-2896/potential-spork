...
let FilterMenu = (props) => {   // Menu to show the filters available for choosing restaurants.
    ...
    return (
        <div>
            <div className = "FilterMenu">
                ...
                <h3>Cuisines</h3>
                {props.cuisineData.map(function(item,index){  // Iterating between each of the available cuisines.
...
let ShowFilter = () => {    // Function to display the filter on click of the Filter Icon.
...
let CloseFilter = () => {   // Function to hide the filter on click of the Close Icon.
